...
const DAILY_HIGH: string[] = [
  "오늘은 흐름이 잘 맞는 날이에요",
  "오늘은 비교적 움직임이 잘 받쳐주는 날이에요",
  "오늘은 에너지가 좋은 편이에요",
  "오늘은 비교적 흐름이 가벼운 편이에요",
  "오늘은 움직임이 자연스럽게 맞아떨어질 수 있어요",
];
const DAILY_MID: string[] = [
  "오늘은 무난하게 흘러가는 날이에요",
  "오늘은 큰 기복 없이 지나가기 쉬운 날이에요",
  "오늘은 전반적으로 차분한 흐름이에요",
  "오늘은 크게 신경 쓸 일 없이 지나가기 쉬운 날이에요",
  "오늘은 흐름이 잔잔한 편이에요",
];
const DAILY_LOW: string[] = [
  "오늘은 속도를 조금 조절하는 게 좋은 날이에요",
  "오늘은 무리하지 않는 편이 더 잘 맞을 수 있어요",
  "오늘은 에너지를 아껴가는 게 필요한 날이에요",
  "오늘은 속도를 줄이는 쪽이 더 편할 수 있어요",
  "오늘은 무리하면 오히려 부담이 될 수 있어요",
];
