...
const samples = [
  pick((a, b) => b.scores.overall - a.scores.overall),   // overall 최고
  pick((a, b) => a.scores.overall - b.scores.overall),   // overall 최저
  pick((a, b) => b.scores.love    - a.scores.love),      // love 최고
];

console.log(JSON.stringify(samples.map(f => buildAiDailyRequest(f)), null, 2));
